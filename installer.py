...
alias aipm_demo_builder='echo "🚀 Launching ToolJet dashboard builder..." && aipm_workflows_status | grep -q "ToolJet - Running" || aipm_workflows && echo "ToolJet ready at: http://localhost:8082" && open http://localhost:8082'
